	...
	<nav class="side-menu">
	    <ul class="side-menu-list">
	        <!--<li class="grey with-sub">
	            <a href="<?php //echo base_url().'page/dashboard';?>"><span>
	                <i class="font-icon font-icon-dashboard"></i>
	                <span class="lbl">Dashboard</span>
	            </span></a>        
	        </li>
			<li class="grey with-sub"><a href="<?php //echo base_url().'page/add_page';?>"><span><i class="font-icon font-icon-page" aria-hidden="true"></i><span class="lbl">Add Page</span></span></a></li>-->
			<li class="grey with-sub"><a href="<?php echo base_url().'user/profile';?>"><span><i class="font-icon font-icon-pen" aria-hidden="true"></i><span class="lbl">Add Element</span></span></a></li>
