					...
					<div class="row m-t-lg">
						...
						<!-- Add element section -->
							<div class="section-style">
								...
								<form name="myform" id="myform" action="<?php echo base_url()?>admin/add_audiomodule" method="post" enctype="multipart/form-data">
										<div class="form-group">
											...
											<!--	<label class="form-label" for="signup_v1-username">Course Id:</label>-->
												...
												<div class="form-control-wrapper">
													<input type="file" class="form-control" name="module_audio" required>
												</div><br>
												...
												<div class="form-control-wrapper">
													<input type="text" class="form-control" name="module_dur" placeholder="Enter Audio Duration" required>
												</div><br>
												...
												<div class="form-group">
													<button type="submit" name="add_audiomodule" class="btn">Save</button>
												</div>	
