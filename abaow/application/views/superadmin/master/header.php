	...
	<nav class="side-menu">
	    <ul class="side-menu-list">
	        <li class="grey with-sub">
	            <a href="<?php echo base_url().'admin/dashboard';?>"><span>
	                <i class="font-icon font-icon-dashboard"></i>
	                <span class="lbl">Dashboard</span>
	            </span></a>        
	        </li>
			<li class="grey with-sub"><a href="<?php echo base_url().'admin/add_course';?>"><span><i class="font-icon font-icon-page" aria-hidden="true"></i><span class="lbl">Add Course</span></span></a></li>
			<li class="grey with-sub"><a href="<?php echo base_url().'admin/add_instructor';?>"><span><i class="font-icon font-icon-user" aria-hidden="true"></i><span class="lbl">Add Instructor</span></span></a></li>
			...
			<li class="grey with-sub"><a href="<?php echo base_url().'admin/add_franchise';?>"><span><i class="font-icon font-icon-build" aria-hidden="true"></i><span class="lbl">Add Franchise</span></span></a></li>
	            <li class="grey with-sub"><a href="<?php echo base_url().'admin/add_blog';?>"><span><i class="font-icon font-icon-build" aria-hidden="true"></i><span class="lbl">Add Blog</span></span></a></li>
	            <li class="grey with-sub"><a href="<?php echo base_url().'admin/add_video';?>"><span><i class="font-icon font-icon-build" aria-hidden="true"></i><span class="lbl">Add Video</span></span></a></li>
	    </ul>
	    </section>
	</nav><!--.side-menu-->